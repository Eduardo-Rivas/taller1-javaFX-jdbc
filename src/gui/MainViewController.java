...
public class MainViewController implements Initializable {
	...
	//--Método Presentción de Pantallas de las Opciones--//
	private synchronized void loadView2(String ruta) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource(ruta));
			...
			//--Instanciamos ManualMente DepartamentoListController--//
			DepartamentoListController controller = loader.getController();
			
			//--Llamamos al Método para Instanciar el Servicio--//
			controller.setDepartamentoService(new DepartamentoService());
			
			//--Manda a Actualizar el TableView--//
			controller.updateObsList();
